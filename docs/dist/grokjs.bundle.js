  ...
  return (function () {
  ...
  })()(
    {
      1: [
        ...
        {
          "./src/attention-mechanism/attention-mechanism": 10,
          "./src/corpus/corpus": 11,
          "./src/counter/counter": 12,
          "./src/embedding/embedding": 13,
          "./src/evaluation-metrics/evaluation-metrics": 14,
          "./src/fact-server/fact-server": 15,
          "./src/form-autocomplete/form-autocomplete": 16,
          "./src/frequency-distribution/frequency-distribution": 17,
          "./src/inference-engine/inference-engine": 18,
          "./src/language-model/language-model": 19,
          "./src/markov-chain/markov-chain": 20,
          "./src/ngram/ngram": 21,
          "./src/normalizer/normalizer": 22,
          "./src/probability-distribution/probability-distribution": 23,
          "./src/tokenizer/tokenizer": 24,
          "./src/vocabulary/vocabulary": 25,
        },
      ],
      ...
      7: [
        function (require, module, exports) {
          ...
          function francAll(value, options = {}) {
            ...
            return normalize(
              value,
              getDistances(
                (0, trigram_utils_1.asTuples)(value),
        ...
        { "./data.js": 5, "./expressions.js": 6, "./trigram-utils": 9 },
      ],
      8: [
        function (require, module, exports) {
          "use strict";
      ...
      9: [
        function (require, module, exports) {
          ...
          function clean(value) {
            ...
            return (0, collapse_white_space_1.collapseWhiteSpace)(
        ...
        { "./collapse-white-space": 4, "./n-gram": 8 },
      ],
      10: [
        function (require, module, exports) {
    ...
    `;
      ...
      `;
        ...
        { "../counter/counter": 12, "../language-model/language-model": 19 },
      ],
      17: [
        function (require, module, exports) {
          const Counter = require("../counter/counter");
      ...
      19: [
        ...
        {
          "../attention-mechanism/attention-mechanism": 10,
          "../counter/counter": 12,
          "../embedding/embedding": 13,
          "../evaluation-metrics/evaluation-metrics": 14,
          "../inference-engine/inference-engine": 18,
          "../ngram/ngram": 21,
          fs: 2,
        },
      ],
      ...
      21: [
        function (require, module, exports) {
          ...
          class Ngram {
            ...
            predictNextWord(prefix) {
              ...
              if (this.debug)
                console.log("Predicting next word for prefix:", prefix, "Tokens:", tokens);
        ...
        { "../counter/counter": 12, "../tokenizer/tokenizer": 24 },
      ],
      22: [
        function (require, module, exports) {
          /**
      ...
      23: [
        ...
        { "../frequency-distribution/frequency-distribution": 17 },
      ],
      24: [
        function (require, module, exports) {
          let franc;

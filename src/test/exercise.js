...
// Train the model
languageModel.train(
  "hello world how are you hello world again. the dog says hello hello and he says goodbye. cheese-its are delicious. hello how are goodbye. hello bye. hi byybye. hello world can we get cheese, it goes really well with everything.",
);

// Predict the next word
console.log(
  'Predictions for "hello world":',
  languageModel.predict("hello world"),
);
...
// Generate text
console.log(
  'Generated text starting with "hello":',
  languageModel.generateText("hello", 3),
);
console.log(
  'Generated text starting with "hello":',
  languageModel.generateText("hello", 4),
);
console.log(
  'Generated text starting with "hello":',
  languageModel.generateText("hello", 5),
);
